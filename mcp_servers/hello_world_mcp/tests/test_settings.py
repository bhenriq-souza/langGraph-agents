"""AC-0015-04, INV-0015-02 and INV-0015-03 — environment-driven settings resolution."""

import pytest
from hello_world_mcp.server import create_server
...
def test_defaults_bind_loopback_stdio() -> None:
    ...
    assert settings.host == "127.0.0.1"  # INV-0015-02
...
def test_non_loopback_host_with_stateful_mode_rejected() -> None:
    # INV-0015-03: horizontal-scaling safety.
    with pytest.raises(ValueError, match="INV-0015-03"):
