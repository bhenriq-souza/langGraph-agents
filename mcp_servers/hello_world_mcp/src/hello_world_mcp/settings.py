"""Environment-driven transport configuration for the hello-world MCP server (spec 0015)."""
...
class ServerSettings:
    """Resolved transport settings, per the spec 0015 configuration table."""
    ...
    def __post_init__(self) -> None:
        ...
        # INV-0015-03: a non-loopback bind must run stateless so multi-instance
        ...
        if not _is_loopback(self.host) and not self.stateless:
            raise ValueError(
                ...
                "(AGENTS_MCP_STATELESS=true); see INV-0015-03."
            )

    @classmethod
    def from_env(cls, env: Mapping[str, str] | None = None) -> ServerSettings:
        """Resolve settings from the environment. Port precedence: PORT > AGENTS_MCP_PORT > 8766."""
